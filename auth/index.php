...
<head>
    ...
    <link rel="icon" href="https://www.tms.lan/favicon.ico">
</head>
<style>
    body {
...
<div class="container">
    <div class="row">
        <div class="col-sm-6 col-md-4 col-md-offset-4 text-center">
            <div class="back">
                <h1 class="text-center login-title">Log in to <br><strong>Tenant Management
                        System</strong>
                </h1>
                <form id="msform" method="POST" enctype="multipart/form-data">
                    <div class="login">
                        ...
                        <fieldset>
                            ...
                            <img src="https://www.tms.lan/images/img_avatar2.png" alt="Default" height="100" class="img-circle">
                        ...
                        <fieldset>
                                <span class="pull-left previous" style="cursor:pointer" name="previous">
                                    <img src="https://www.tms.lan/images/arrow_back.png" alt="Back">
                                </span>
                            <span class="img" id="img">
                                    <img src="https://www.tms.lan/images/img_avatar2.png" alt="" height="100" class="img-circle">
                                </span>
