...
setcookie("login","login",time()-60*60*2,'/','tmsystem.live',true,true);
setcookie('user','',time()-60*60*24*2,'/','tmsystem.live',true,true);
setcookie('passwd','',time()-60*60*24*2,'/','tmsystem.live',true,true);
