...
<?php
$ret;
if (isset($_COOKIE['login']) && $_COOKIE['login'] == "login" && isset($_COOKIE['token'])) {
    echo "<script>console.log({$_COOKIE['user']})</script>";
	echo '<script>
		window.location = "https://www.tmsystem.live/actions/login.php?token='.$_COOKIE['token'].'";
	</script>';
...
<body class="is-boxed has-animations">
						...
						<div class="hero-copy">
							...
							<div class="hero-cta">
								<div class="lights-toggle">
									<input id="lights-toggle" type="checkbox" name="lights-toggle" class="switch" checked="false">
			...
			<div class="container">
				<div class="site-footer-inner">
					...
					<ul class="footer-links list-reset">
						<li>
							<a href="/redirectlogin.php">Login</a>
						</li>
						<li>
							<a href="/cli">Clients Page</a>
						</li>
						<li>
					...
					<ul class="footer-social-links list-reset">
						...
						<li>
							<a href="//api.whatsapp.com/send?phone=+256705568794">
	...
	<script>
		...
		$('header.contact_title').get(0).addEventListener('click', ()=>b())
		if (loggedIn) {
